...
class HomeScreenWell extends StatefulWidget {
  final String title;
  ...
  @override
  State<HomeScreenWell> createState() => _HomeScreenWellState();
}

class _HomeScreenWellState extends State<HomeScreenWell> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  ...
                  cardSecond1Widget(
                      context,
                      "Temperatura (°C):",
                      _dataMessage.isNotEmpty ? getMTemp() : "",
                      'assets/images/speed_water.png'),
            ...
            dataValueWidget(context, "Quduq nomi:",
