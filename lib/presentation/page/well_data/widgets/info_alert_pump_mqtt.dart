...
class InfoAlertPumpMqtt extends StatefulWidget {
  ...
  @override
  State<InfoAlertPumpMqtt> createState() => _InfoAlertPumpMqttState();
}

class _InfoAlertPumpMqttState extends State<InfoAlertPumpMqtt> {
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => DashboradMqttPump(
                                pumpMqttData: widget.pumpMqttData,
                              )));
                },
                child: Text(
